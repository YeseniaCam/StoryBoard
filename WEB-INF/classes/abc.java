...
public class abc extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ListUsers listu = new ListUsers(ruta);
        List<User> l = listu.generateList();     
        ...
        out.println("<h1>Altas-Bajas-Cambios</h1>");

        out.println("<a href='NuevoUsuario'><button class='btn btn-primary'><i class='fas fa-plus'></i></button></a>");
        out.println("<br/>");
        out.println("<br/>");
        ...
        for (User u : l) {
            out.println("<tr>");
                ...
                out.println("<td>"+u.correo+"</td>");
                out.println("<td>"+u.tipo+"</td>");
                out.println("<td class = 'text-center'>");
                    out.println("<a href='modify?user="+u.username+"'><button class='btn btn-warning'><i class='fas fa-pencil-alt'></i></button></a>");
                    out.println("<button name ='"+u.username+"'class='btn btn-danger' onclick='confirmf(this.name)'><i class='fas fa-trash-alt'></i></button>");
                out.println("</td>");
            out.println("</tr>");
        }
        out.println("</tbody>");
